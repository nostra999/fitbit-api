	...
	Function Process()
	{
		switch(intval($this->oauth_version))
		{
			case 1:
				...
				if ($_SESSION["force_oauth"] == true) {
				$access_token["value"] = $_SESSION['ses_token'];
				$access_token["secret"] = $_SESSION['ses_secret']; 
				...
				//$access_token["value"] = 'f6da881a6c8ae2c17ecba1f79b8eef04';
				//$access_token["secret"] = 'eb635778db599c992cc1a986d9df77e5';
				//$access_token["authorized"] = true;
